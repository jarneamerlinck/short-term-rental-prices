...
Repository: https://github.com/jarneamerlinck/short-term-rental-prices

Releases/tags: https://github.com/jarneamerlinck/short-term-rental-prices/releases/

Wandb: https://wandb.ai/jarne-amerlinck/nyc_airbnb/

Model linage: https://wandb.ai/jarne-amerlinck/nyc_airbnb/artifacts/model_export/random_forest_export/v15/lineage
...
```bash
mlflow run git@gitlab.com:jarneamerlinck-do/short-term-rental-prices.git \
             -v 1.0.0 \
